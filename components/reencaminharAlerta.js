    ...
    <div class="">
        <div class="link row">
          ...
          <div class="inputContainer d-flex col-md-12 col-lg-8" >
            <input v-model="value" disabled="disabled" class="form-control" style="background-color:#fff"/>
            <span @click="copiarLink" class="cp" style="background-color:#fff">Copiar</span>
